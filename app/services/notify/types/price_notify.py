...
class PriceNotifier(INotified, WithDelegates, WithLogger):
    ...
    #     sticker = self._next_ath_sticker()
    ...
    async def do_notify_price_table(self, market_info: RuneMarketInfo, hist_prices: tuple, ath: bool,
        ...
        #     caption = loc.notification_text_price_update(price_alert)
